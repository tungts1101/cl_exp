...
data_table = {
    "cifar224": [(5, 20, 20), (20, 5, 5)],
    "omnibenchmark": [(5, 60, 60), (20, 15, 15)],
    "cub": [(5, 40, 40), (20, 10, 10)],
    "imagenetr": [(5, 40, 40), (20, 10, 10)],
    "imageneta": [(5, 40, 40), (20, 10, 10)],
}

for model_backbone in ["vit_base_patch16_224_lora"]:
    for dataset_name in ["imageneta", "cub", "omnibenchmark", "cifar224"]:
