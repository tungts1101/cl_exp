...
def setup_logger(log_file=f'logs/{timestamp}_magmax.log'):
...
def merge(base_params, tasks_params, lamb=1.0):
    params = {}
...
class Learner:
    ...
    def merge(self):
        ...
        backbone_params = merge(base_params, session_params, lamb=self._config["model_merge_coef"])
...
for model_backbone in ["vit_base_patch16_224_magmax"]:
