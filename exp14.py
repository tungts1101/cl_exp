...
class Net(nn.Module):
    def __init__(self):
        ...
        self.Win1 = nn.Parameter(torch.randn(embed_dim, M))
        self.Win2 = nn.Parameter(torch.randn(embed_dim, 5000))

        self.W = nn.Parameter(torch.zeros(M, num_classes))
        self.fc = nn.Linear(self.base.embed_dim, num_classes, bias=False)
